...
func (o *GetNamespacesNamespaceActivationsActivationidLogsURL) Build() (*url.URL, error) {
	...
	if activationid != "" {
		...
		return nil, errors.New("Activationid is required on GetNamespacesNamespaceActivationsActivationidLogsURL")
	}
	...
	if namespace != "" {
		...
		return nil, errors.New("Namespace is required on GetNamespacesNamespaceActivationsActivationidLogsURL")
	}
...
func (o *GetNamespacesNamespaceActivationsActivationidLogsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNamespacesNamespaceActivationsActivationidLogsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNamespacesNamespaceActivationsActivationidLogsURL")
	}
